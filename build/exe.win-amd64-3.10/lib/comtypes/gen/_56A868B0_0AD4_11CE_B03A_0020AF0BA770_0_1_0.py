...
__all__ = [
    'LONG_PTR', 'IMediaControl', 'IDeferredCommand', 'IBasicAudio',
    'IVideoWindow', 'IPinInfo', 'IMediaEventEx', 'IQueueCommand',
    'IMediaTypeInfo', 'IAMCollection', 'IBasicVideo', 'IAMStats',
    'IBasicVideo2', 'IMediaEvent', 'FilgraphManager',
    'IMediaPosition', 'IRegFilterInfo', 'IFilterInfo'
]

_check_version('1.2.0', 1662606571.625398)
