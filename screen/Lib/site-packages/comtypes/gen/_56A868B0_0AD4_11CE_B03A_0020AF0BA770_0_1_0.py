...
__all__ = [
    'IQueueCommand', 'IAMStats', 'IMediaTypeInfo', 'IBasicAudio',
    'IPinInfo', 'IVideoWindow', 'IDeferredCommand', 'IMediaEvent',
    'IAMCollection', 'IBasicVideo', 'IRegFilterInfo', 'LONG_PTR',
    'IMediaControl', 'IMediaEventEx', 'FilgraphManager',
    'IBasicVideo2', 'IMediaPosition', 'IFilterInfo'
]
